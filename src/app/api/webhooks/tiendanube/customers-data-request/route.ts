...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`[WEBHOOK] Processing data request for customer: ${customer_id} in store: ${store_id}`);
    ...
    console.log(`[WEBHOOK] Data request completed for customer: ${customer_id}`);
